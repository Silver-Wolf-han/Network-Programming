...
int main(int argc, char* argv[]) {
    ...
    if (argv[1] && chdir("working_directory") < 0) {
        cerr << "Error: cd: working_directory : No such file or directory" << endl;
        cerr << "Please create \'working directory\' with \'bin\' directory" << endl;
    }
